...
export function get_extension(mime_type, expands, defaultExt) {
    let _mime_types = Object.assign({}, mime_db, expands);
...
export function set_deep_value(obj, path, val) {
    ...
    while (nested != null && ++index < length) {
        ...
        if (index != lastIndex) {
            ...
            // why is it "index + 1"
            newValue = isTypeObject(objValue)
          ? objValue : (isIndex(__path[index + 1]) ? [] : {});
        }
